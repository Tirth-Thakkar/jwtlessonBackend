...
public class PersonApiController {
    ...
    public ResponseEntity<Object> postPerson(@RequestParam("email") String email,
            ...
            @RequestParam("isDegenerate") String isDegenerate,
            @RequestParam("smartCarColor") String smartCarColor,
        ...
        // student
        Person person = new Person(email, password, name, hobby, isDegenerate, smartCarColor, dob);
